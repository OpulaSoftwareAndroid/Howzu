...
public class ImageStorage {
    ...
    public String saveToSdCard(Bitmap bitmap, String from, String filename) {
        ...
        String path = "";
        if (from.equals("sent")) {
            path = "/" + context.getString(R.string.app_name) + "Images/Sent";
        } else if (from.equals("profile")) {
            path = "/" + context.getString(R.string.app_name) + "Images/MainViewProfileDetailActivity";
        } else {
            path = "/" + context.getString(R.string.app_name) + "Images";
        }
    ...
    public File getImage(String from, String imagename) {
        ...
        try {
            ...
            if (from.equals("sent")) {
                ...
                path = "/" + context.getString(R.string.app_name) + "Images/.thumbnails/";
            } else {
                path = "/" + context.getString(R.string.app_name) + "Images/";
            }
