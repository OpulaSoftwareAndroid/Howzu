...
public class PeerConnectionClient {
    ...
    private static final String TAG = "CallActPeer";
    ...
    public static class PeerConnectionParameters {
        ...
        public static PeerConnectionParameters createVideoDefault() {
        ...
        public PeerConnectionParameters(boolean videoCallEnabled, boolean loopback, boolean tracing,
                                        ...
                                        boolean enableLevelControl, boolean useLegacyAudioDevice) {
            this(videoCallEnabled, loopback, tracing, videoWidth, videoHeight, videoFps, videoMaxBitrate,
                    ...
                    disableBuiltInNS, enableLevelControl, useLegacyAudioDevice, null);
        }
        ...
        public PeerConnectionParameters(boolean videoCallEnabled, boolean loopback, boolean tracing,
                                        ...
                                        String audioCodec, boolean noAudioProcessing, boolean aecDump, boolean useOpenSLES,
                                        boolean disableBuiltInAEC, boolean disableBuiltInAGC, boolean disableBuiltInNS,
                                        boolean enableLevelControl, boolean useLegacyAudioDevice, DataChannelParameters dataChannelParameters) {
    ...
    public void createPeerConnection(final EglBase.Context renderEGLContext,
                                     ...
                                     final VideoCapturer videoCapturer, List<PeerConnection.IceServer> iceServers) {
    ...
    private VideoTrack createVideoTrack(VideoCapturer capturer) {
        ...
        localVideoTrack.setEnabled(renderVideo);
        if (localVideoTrack == null){
            Log.v(TAG, "localVideoTrack null");
        }
        if (localRender == null){
            Log.v(TAG, "localRender null");
        }
