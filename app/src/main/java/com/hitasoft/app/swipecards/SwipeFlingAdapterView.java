package com.hitasoft.app.swipecards;
...
public class SwipeFlingAdapterView extends BaseFlingAdapterView {
    ...
    public SwipeFlingAdapterView(Context context, AttributeSet attr, int defStyle) {
        super(context, attr, defStyle);

        TypedArray a = context.obtainStyledAttributes(attr, R.styleable.SwipeFlingAdapterView, defStyle, 0);
    ...
    //Create below method in SwiprFillingAdapterView
    public void undo() {
        removeAllViewsInLayout();
